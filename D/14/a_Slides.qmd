...
If Y is an arbitrary scale, you might be tempted to standardize Y globally before fitting your model (like you would for OLS). [Do not do this for multilevel data!]{.b .dark-red} 
