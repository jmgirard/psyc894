...
## The Need for a Meaningful Zero {.fsmaller}
...
## Centering Level 2 Predictors {.fsmaller}
...
## Standardizing Level 2 Predictors {.fsmaller}
...
## The Problem with Level 1 Predictors {.fsmaller}
...
## Multilevel Fallacies and Paradoxes {.fsmaller}
...
## Manifest Decomposition (Degrouping) {.fsmaller}
...
## The Magic of Orthogonality {.fsmaller}
...
## Do We Always Need Both Components? {.fsmaller}
...
## Standardizing Level 1 Predictors {.fsmaller}
...
## What About Standardizing Y? {.fsmaller}
...
## Best Practice Recommendations {.fsmaller}
...
## The Weighting Problem {.fsmaller}
...
## The "Split, Transform, Join" Workflow {.fsmaller}
...
## Model 1: Establishing Main Effects {.fsmaller}
...
## Model 1C: Centered Equations {.fsmaller}
...
## Model 1C: Mixed Equation {.fsmaller}
...
## Model 1C: Interpretation {.fsmaller}
...
## Model 1S: Standardized Equations {.fsmaller}
...
## Model 1S: Interpretation {.fsmaller}
...
## Model 2: Moving to Moderation {.fsmaller}
...
## Model 2C: Centered Equations {.fsmaller}
...
## Model 2C: Mixed Equation {.fsmaller}
...
## Model 2C: Interpretation {.fsmaller}
...
## Model 2S: Standardized Equations {.fsmaller}
...
## Model 2S: Interpretation {.fsmaller}
