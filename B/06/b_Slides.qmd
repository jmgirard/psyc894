...
$$
\begin{alignat}{2}
&\text{L1:} \quad & y_{ij} &= \beta_{0j} + e_{ij} \\
&\text{L2:} \quad & \beta_{0j} &= \color{#377eb8}{\gamma_{00}} + \color{#984ea3}{\gamma_{01}} z_j + u_{0j}
\end{alignat}
$$
...
$$
y_{ij} = (\color{#377eb8}{\gamma_{00}} + \color{#984ea3}{\gamma_{01}} z_j + u_{0j}) + e_{ij}
$$
...
$$
y_{ij} = \underbrace{\color{#377eb8}{\gamma_{00}} + \color{#984ea3}{\gamma_{01}} z_j}_{\text{Fixed}} + \underbrace{u_{0j} + e_{ij}}_{\text{Random}}
$$
:::
...
> ...the **Cluster Average** $(\beta_{0j})$ (the expected average when $x_{ij}=0$) plus the **Effect of Predictor $x$** $(\color{#ff7f00}{\beta_{1j}} x_{ij})$ plus the **Observation Deviation** $(e_{ij})$.
...
$$
\begin{align}
\text{MATH}_{ij} &= \beta_{0j} + \color{#ff7f00}{\beta_{1j}} \text{FEMALE}_{ij} + e_{ij} \\
\beta_{0j} &= \color{#377eb8}{\gamma_{00}} + u_{0j} \\
\color{#ff7f00}{\beta_{1j}} &= \color{#ff7f00}{\gamma_{10}}
\end{align}
$$
...
$$
\begin{alignat}{2}
&\text{L1:} \quad & y_{ij} &= \beta_{0j} + \color{#ff7f00}{\beta_{1j}} x_{ij} + e_{ij} \\
&\text{L2:} \quad & \beta_{0j} &= \color{#377eb8}{\gamma_{00}} + u_{0j} \\
&                 & \color{#ff7f00}{\beta_{1j}} &= \color{#ff7f00}{\gamma_{10}}
\end{alignat}
$$
...
$$
y_{ij} = (\color{#377eb8}{\gamma_{00}} + u_{0j}) + (\color{#ff7f00}{\gamma_{10}}) x_{ij} + e_{ij}
$$
...
$$
y_{ij} = \underbrace{\color{#377eb8}{\gamma_{00}} + \color{#ff7f00}{\gamma_{10}} x_{ij}}_{\text{Fixed}} + \underbrace{u_{0j} + e_{ij}}_{\text{Random}}
$$
:::
